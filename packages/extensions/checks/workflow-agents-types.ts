...
import { RebyteExtensions, type WorkflowRun, type WorkflowRunEvent, type WorkflowDraft } from '@rebyteai/agent-extensions';
import type { Stream } from 'openai/core/streaming';
import type { WorkflowDefinition } from '@rebyteai/agent-extensions';

async function contracts(client: RebyteExtensions, stream: boolean) {
