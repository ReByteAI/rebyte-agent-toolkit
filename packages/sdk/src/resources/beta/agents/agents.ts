 ...
 */
export type HostedSkill = RebyteGitHubSkill | HostedSkillReference | HostedSkill.HostedSkillResourceInline;
...
/** Rebyte extension: installed once when the Session Sandbox is first created. */
export type RebyteGitHubSkillParam = {
  type: 'github';
  /** HTTPS repository URL with a name, or a full tree URL to a skill directory. */
  url: string;
  name?: string;
};

export type RebyteGitHubSkill = RebyteGitHubSkillParam & { description?: string };
