...
import { AbstractPage, PagePromise, type CursorPageResponse, type PageRequestOptions } from '../../core/pagination';
...
export class WorkflowVersionsPage extends AbstractPage<WorkflowVersion> {
  ...
  has_more: boolean;
  constructor(client: OpenAI, response: Response, body: CursorPageResponse<WorkflowVersion>, options: FinalRequestOptions) {
  ...
  nextPageRequestOptions(): PageRequestOptions | null {
    ...
    return { ...this.options, query: { ...maybeObj(this.options.query), before: last.version } };
  }
}
